...
GO
ALTER TABLE [dbo].[course] DROP CONSTRAINT [UQ__course__AB6B45F194F1FD28];
...
GO
ALTER TABLE [dbo].[course] ALTER COLUMN [course_code] NVARCHAR (50) NOT NULL;
...
ALTER TABLE [dbo].[course]
    ADD UNIQUE NONCLUSTERED ([course_code] ASC);
